...
const songs = [
        ...
        },
        {
            ...
            keySignature: "C",
            youtubeLink: "https://youtu.be/C1itKzwJE4g?si=C_lNIvMhcCWTcKwv",
            verses: [
                [
                    { chord: "C", text: "(C) Oh how sweet the glorious message" },
                    { chord: "F", text: "(F) Simple faith may (C) claim;" },
                    { chord: "C", text: "(C) Yesterday, today, forever" },
                    { chord: "D", text: "(D) Jesus is the (G) same!" },
                    { chord: "C", text: "(C) Still He loves to save the sinful" },
                    { chord: "F", text: "(F) Heal the sick and (C) lame" },
                    { chord: "C", text: "(C) Cheer the mourner, Calm the tempest" },
                    { chord: "G", text: "(G) Glory to His (C) name!" },
                ],
                [
                    { chord: "", text: "CHORUS:" },
                    { chord: "C", text: "(C) Yesterday, (F) today, forever" },
                    { chord: "C", text: "(C) Jesus (D) is the (G) same!" },
                    { chord: "C", text: "(C) All may change but (F) Jesus never," },
                ...
                [
                    { chord: "C", text: "(C) He who pardonned erring Peter" },
                    { chord: "F", text: "(F) Never needst thou (C) fear;" },
                    { chord: "C", text: "(C) He who came to faithless Thomas" },
                    { chord: "D", text: "(D) All thy doubt will (G) clear!" },
                    { chord: "C", text: "(C) He who let the loved disciple" },
                    { chord: "F", text: "(F) On His bosom (C) rest" },
                    { chord: "C", text: "(C) Bids thee still, with love as tender," },
                    { chord: "G", text: "(G) Lean upon His (C) breast." },
                ],
                [
                    { chord: "C", text: "(C) As of old He walked to Emmaus," },
                    { chord: "F", text: "(F) With them to (C) abide;" },
                    { chord: "C", text: "(C) So through all life’s way He walketh," },
                    { chord: "D", text: "(D) Ever near our (G) side." },
                    { chord: "C", text: "(C) Soon again we shall behold Him," },
                    { chord: "F", text: "(F) Hasten, Lord, the (C) day!" },
                    { chord: "C", text: "(C) But ’twill still be “this same Jesus,”" },
                    { chord: "G", text: "(G) As He went (C) away." },
                ]
            ]
        },
        {
            ...
            keySignature: "C",
            youtubeLink: "https://youtu.be/abKCrE5K_04?si=JvU1kyT4u_XUgqmK",
            verses: [
                [
                    { chord: "C", text: "(C) Laissons voir (F) notre (C) joie," },
                    { chord: "C", text: "(C) Nous qui (D) aimons le (G) Seigneur," },
                    { chord: "C", text: "(C) Joignons au chant un (F) doux accord," },
                    { chord: "G", text: "(G) Joignons au chant un (F) doux (C) accord," },
                    { chord: "C", text: "(C) Et en- (G) -vi- (C) -ronnons le (F) trône," },
                    { chord: "C", text: "(C) Et envi- (G) -ronnons le (C) trône." }
                ],
                [
                    { chord: "", text: "CHORUS:" },
                    { chord: "C", text: "(C) Nous marchons vers Sion," },
                    { chord: "C", text: "(C) Merveilleuse, (D) merveilleuse (G) Sion;" },
                    { chord: "C", text: "(C) Nous montons tout droit vers (F) Sion," },
                    { chord: "C", text: "(C) La merveilleuse (G) Cité de (C) Dieu." }
                ],
                [
                    { chord: "C", text: "(C) Qu’ils refusent (F) de (C) chanter" },
                    { chord: "C", text: "(C) Ceux qui ne (D) connaissent pas (G) Dieu" },
                    { chord: "C", text: "(C) Mais tous les enfants du (F) Roi céleste," },
                    { chord: "G", text: "(G) Mais tous les enfants du (F) Roi (C) céleste," },
                    { chord: "C", text: "(C) Procla- (G) -me- (C) -ront leur (F) joie," },
                    { chord: "C", text: "(C) Proclame- (G) -ront leur (C) joie." }
                ],
                [
                    { chord: "C", text: "(C) La colline (F) de (C) Sion" },
                    { chord: "C", text: "(C) Produit des (D) délices (G) sacrées" },
                    { chord: "C", text: "(C) Avant que nous attei- (F) -gnions le Ciel," },
                    { chord: "G", text: "(G) Avant que nous attei- (F) -gnions (C) le Ciel," },
                    { chord: "C", text: "(C) Ou marchions (G) sur (C) les rues (F) d’or," },
                    { chord: "C", text: "(C) Ou marchions (G) sur les rues (C) d’or." }
                ],
                [
                    { chord: "C", text: "(C) Puissent nos chants (F) abonder, (C) " },
                    { chord: "C", text: "(C) Et chaque larme (D) être (G) séchée;" },
                    { chord: "C", text: "(C) Nous marchons sur le (F) sol d’Emmanuel," },
                    { chord: "G", text: "(G) Nous marchons sur le (F) sol (C) d’Emmanuel," },
                    { chord: "C", text: "(C) Vers les (G) beaux (C) pays d’En (F) haut," },
                    { chord: "C", text: "(C) Vers les (G) beaux pays d’En (C) haut." }
                ]
            ]
        },
        {
        ...
        {
            key: "dim-20-04-2025",
            title: "LA VICTOIRE EST FUR SON EPAULE",
            keySignature: "C",
            ...
            verses: [
                ...
                [
                    { chord: "C", text: "(C) La victoire est sur son épaule" },
                    { chord: "C", text: "(C) Son Nom est le Sei (D) gneur Jé (G) sus " },
                    { chord: "C", text: "(C) Merveilleux, Conseillé et le (F) Prince de (C) paix" },
                    { chord: "C", text: "(C) Il est (F) Roi, il est (G) vraiment (C) Roi" }
                ],
            ]
        },
        ...
        },
        {
            ...
            title: "AT THE CROSS",
            keySignature: "C",
            youtubeLink: "https://youtu.be/F02SYN3zByk?si=b-7hEjP4eJZIFJ3M",
            verses: [
                [
                    { chord: "C", text: "(C) Alas, and did my Savior bleed?" },
                    { chord: "C", text: "(C) And (F) did my (D) Sovereign (G) die?" },
                    { chord: "G", text: "(G) Would (C) He devote that sacred head" },
                    { chord: "C", text: "(C) For (F) such a (G) worm as (C) I?" },
                ],
                [
                    { chord: "", text: "CHORUS:" },
                    { chord: "C", text: "(C) At the cross, at the cross where" },
                    { chord: "G", text: "(G) I first saw the light," },
                    { chord: "G", text: "(G) And the burden of my heart rolled (C) away," },
                    { chord: "C", text: "(C) It was (F) there by faith I (C) received my (Am) sight," },
                    { chord: "Am", text: "(Am) And (G) now I am happy all the (C) day!" },
                ],
                [
                    { chord: "C", text: "(C) Was it for sins that I had done" },
                    { chord: "C", text: "(C) He (F) groaned (D) upon the (G) tree?" },
                    { chord: "G", text: "(G) Amazing (C) pity! grace unknown!" },
                    { chord: "C", text: "(C) And (F) love (G) beyond (C) degree!" },
                ],
                [
                    { chord: "C", text: "(C) Well might the sun in darkness hide," },
                    { chord: "C", text: "(C) And (F) shut (D) His glories (G) in," },
                    { chord: "G", text: "(G) When (C) Christ, the mighty Maker, died" },
                    { chord: "C", text: "(C) For (F) man, (G) His creature’s (C) sin." },
                ],
                [
                    { chord: "C", text: "(C) Thus might I hide my blushing face" },
                    { chord: "C", text: "(C) While (F) His (D) dear cross (G) appears." },
                    { chord: "G", text: "(G) Dissolve (C) my heart in thankfulness," },
                    { chord: "C", text: "(C) And (F) melt (G) mine eyes to (C) tears." },
                ],
                [
                    { chord: "C", text: "(C) But drops of grief can ne’er repay" },
                    { chord: "C", text: "(C) The (F) debt (D) of love I (G) owe;" },
                    { chord: "G", text: "(G) Here, (C) Lord, I give myself away," },
                    { chord: "C", text: "(C) ’Tis (F) all (G) that I can (C) do." },
                ]
            ]
        },
        {
        ...
        {
            key: "dim-30-03-2025",
            title: "JESUS PRENDS MA VIE",
            keySignature: "C",
            youtubeLink: "https://youtu.be/1gT8gNC_7lY?si=uAzk67-93d2QjTCq",
            verses: [
                [
                    { chord: "C", text: "(C) Qu’il fait beau à ton service (F) " },
                    { chord: "C", text: "(C) Jésus (D) mon (G) Sauveur ! " },
                    { chord: "C", text: "(C) Qu’il m’est doux en sacrifice (F) " },
                    { chord: "Dm", text: "(Dm) De t’offrir (G) mon (C) cœur ! " },
                ],
                [
                    { chord: "", text: "CHORUS:" },
                    { chord: "C", text: "(C) Prends ô, (F) Jésus ! prends ma (C) vie " },
                    { chord: "C", text: "(C) Elle est (D) toute à (G) Toi" },
                    { chord: "C", text: "(C) Et dans (F) ta grâce (C) infinie (Am) " },
                    { chord: "F", text: "(F) Du mal (G) sauve (C) moi" },
                ],
                [
                    { chord: "C", text: "(C) Pour me posséder toi-même (F) " },
                    { chord: "C", text: "(C) Tu m’as (D) racheté (G) " },
                    { chord: "C", text: "(C) Fais que désormais je (F) n’aime " },
                    { chord: "Dm", text: "(Dm) Que ta (G) volonté (C) " },
                ],
                [
                    { chord: "C", text: "(C) Comme l’Ange au vol rapide (F) " },
                    { chord: "C", text: "(C) Je veux (D) te servir (G) " },
                    { chord: "C", text: "(C) Je veux te servir ô, mon (F) guide " },
                    { chord: "Dm", text: "(Dm) Toujours (G) t’obéir. (C) " },
                ],
            ]
        },
        {
        ...
        // Fin Cantiques du 30 Mars 2025 (Treisième Dimanche de l'année 2025)
        ...
        },
        {
            ...
            title: "VIEUX PELERIN",
            keySignature: "C",
            youtubeLink: "https://youtu.be/WH4e32d2aPA?si=RJ9hQDhl0JeVu__m",
            verses: [
                [
                    { chord: "Am", text: "(Am) Vieux pèlerin (G) qui (Am) vagabonde" },
                    { chord: "Am", text: "(Am) Je suis (G) partout un (F) étranger (Am) " },
                    { chord: "Am", text: "(Am) Mais je suis sûr (G) qu’en l’autre (Am) Monde" },
                    { chord: "Am", text: "(Am) Dieu va (Dm) m’offrir (G) où me (Am) loger." },
                    { chord: "Am", text: "(Am) Je vais (F) là-bas (G) revoir mon (Am) Père ;" },
                    { chord: "Am", text: "(Am) Fini pour (F) moi de (G) cheminer (Am) !" },
                    { chord: "Am", text: "(Am) A l’autre (Dm) bord de (G) la Rivière (Am) " },
                    { chord: "Am", text: "(Am) Maison à (G) moi je (Dm) vais (Am) trouver." },
                ],
                [
                    { chord: "Am", text: "(Am) J’achèverai (G) bientôt (Am) ma route" },
                    { chord: "Am", text: "(Am) J’entends (G) tout proche (F) le Jourdain (Am) " },
                    { chord: "Am", text: "(Am) La mort n’a (G) rien que je (Am) redoute" },
                    { chord: "Am", text: "(Am) J’y laisserai (Dm) tous (G) mes (Am) chagrins." },
                    { chord: "Am", text: "(Am) Je vais (F) là-bas (G) revoir mon (Am) Père" },
                    { chord: "Am", text: "(Am) Près de Lui (F) enfin me (G) consoler (Am) " },
                    { chord: "Am", text: "(Am) A l’autre (Dm) bord de (G) la Rivière (Am) " },
                    { chord: "Am", text: "(Am) A la maison (G) me (Dm) reposer (Am) " },
                ],
                [
                    { chord: "Am", text: "(Am) Voici la (G) fin de mes (Am) souffrances" },
                    { chord: "Am", text: "(Am) Et le repos (G) de mon (F) vieux corps (Am) " },
                    { chord: "Am", text: "(Am) Voici venir (G) la récompense (Am) " },
                    { chord: "Am", text: "(Am) Par Dieu (Dm) promise (G) à mes (Am) efforts !" },
                    { chord: "Am", text: "(Am) Je vais (F) là-bas (G) parmi les (Am) Anges" },
                    { chord: "Am", text: "(Am) En oubliant (F) mes vieux (G) soucis (Am) " },
                    { chord: "Am", text: "(Am) Passer mon (Dm) temps à (G) sa louange (Am) " },
                    { chord: "Am", text: "(Am) Dire à Jésus, (G) sans (Dm) fin, merci. (Am) " },
                ]
            ]
        },
        {
        ...
        },
        {
            ...
            verses: [
                [
                    { chord: "C", text: "(C) On Jordan's stormy (F) banks I stand," },
                    { chord: "C", text: "(C) And cast a (D) wishful (G) eye" },
                    { chord: "C", text: "(C) To Canaan's fair and happy land," },
                    { chord: "C", text: "(C) Where my (G) possessions (C) lie." }
                ],
                [
                    { chord: "", text: "CHORUS:" },
                    { chord: "C", text: "(C) I am bound for the (F) promised land," },
                    { chord: "C", text: "(C) I am bound for the (D) promised (G) land," },
                    { chord: "C", text: "(C) Oh, who will come and go with me?" },
                    { chord: "C", text: "(C) I am bound for the (G) promised (C) land." }
                ],
                [
                    { chord: "C", text: "(C) O'er all those wide (F) extended plains" },
                    { chord: "C", text: "(C) Shines one (D) eternal (G) day;" },
                    { chord: "C", text: "(C) There God the Son forever reigns," },
                    { chord: "C", text: "(C) And scatters (G) night (C) away." }
                ],
                [
                    { chord: "C", text: "(C) No chilling winds or (F) poisonous breath" },
                    { chord: "C", text: "(C) Can reach that (D) healthful (G) shore;" },
                    { chord: "C", text: "(C) Sickness and sorrow, pain and death," },
                    { chord: "C", text: "(C) Are felt and (G) feared no (C) more." }
                ]
            ]
        },
        ...
        //Fin Cantiques Dimanche 26 Janvier 2025 (Quatrième Dimanche de l'année 2025)
        ...
        //Fin Cantiques Dimanche 29 Décembre 2024 (Dernier du mois et de l'année 2024)
    ...
    {
        key: "dim-06-10-2024",
        title: "YOU ASK WHY I’M HAPPY",
        keySignature: "C",
        youtubeLink: "https://youtu.be/ZUDyHChBlTg?si=PB5Sur-pGV4L5cjC",
        verses: [
            [
                { chord: "C", text: "(C) You ask why I am happy" },
                { chord: "C", text: "(C) So (G) I'll just tell you why," },
                { chord: "G", text: "(G) Because my sins are (C) gone;" },
                { chord: "C", text: "(C) And when I meet the scoffers" },
                { chord: "C", text: "(C) Who (G) ask me where they are," },
    ...
    // Fin Cantiques Dimanche 06 Octobre 2024

// ------------------------------------------------------------------------------------ //

    // Debut Cantiques Dimanche 29 Septembre 2024
    {
        key: "dim-29-09-2024",
        title: "I NEED THEE",
        keySignature: "C",
    ...
    },
    {
        ...
        keySignature: "C",
        youtubeLink: "https://youtu.be/nKp9B__VCY4?si=TXabN0Znb58f1qbt",
        verses: [
            [
                { chord: "C", text: "(C) God’s attributes were manifested" },
                { chord: "C", text: "(C) To His (F) Bride in this last (C) age." },
                { chord: "C", text: "(C) We have caught the revelation" },
                { chord: "C", text: "(C) By the (D) last prophet’s (G) message." },
                { chord: "C", text: "(C) And we know who we are" },
                { chord: "C", text: "(C) And (F) what we are raised up for" },
                { chord: "F", text: "(F) Praise the (G) Lord, for the Original (C) Life." }
            ],
            [
                { chord: "", text: "CHORUS:" },
                { chord: "C", text: "(C) The Original Life, the Original (F) Seed" },
                { chord: "F", text: "(F) The Original (G) Word is what I (C) believe." },
                { chord: "C", text: "(C) The Son of Man is revealed" },
                { chord: "C", text: "(C) The seventh (F) seal is unveiled" },
                { chord: "F", text: "(F) The Original (G) Life, the Original (C) Seed." }
            ],
            [
                { chord: "C", text: "(C) We are the Word made flesh today" },
                { chord: "C", text: "(C) This is (F) what the Scriptures (C) say." },
                { chord: "C", text: "(C) And our names are seen within," },
                { chord: "C", text: "(C) Redeemed and (D) perfect without (G) sin." },
                { chord: "C", text: "(C) Yes, we are anointed (F) and inspired" },
                { chord: "G", text: "(G) By our God, Who’s the Original (C) Life." }
            ],
            [
                { chord: "C", text: "(C) Our eyes of understanding" },
                { chord: "C", text: "(C) He has (F) opened up (C) at last." },
                { chord: "C", text: "(C) And sweet victory is ours" },
                { chord: "C", text: "(C) Who were (D) chained down in the (G) past." },
                { chord: "C", text: "(C) True Jubilee has sounded" },
                { chord: "C", text: "(C) And (F) we have responded" },
                { chord: "F", text: "(F) To our (G) God, Who’s the Original (C) Life." },
            ],
            [
                { chord: "C", text: "(C) We are called unto adoption" },
                { chord: "C", text: "(C) Full (F) authority and (C) power" },
                { chord: "C", text: "(C) Sleeping saints will wake and join us" },
                { chord: "C", text: "(C) For (D) translation in this (G) hour." },
                { chord: "C", text: "(C) Gentiles’ days soon will be over" },
                { chord: "F", text: "(F) Glory, hallelujah!" },
                { chord: "F", text: "(F) To our (G) God, Who’s the Original (C) Life." }
            ]
        ]
    },
    ...
    // Fin Cantiques Dimanche 29 Septembre 2024

//------------------------------------------------------------------------------------ //
    
    // Debut Cantiques Dimanche 22 Septembre 2024
    {
        key: "dim-22-09-2024",
        title: "HOLD TO GOD'S UNCHANGING HAND",
        keySignature: "C",
    ...
    },
    {
        ...
        keySignature: "C",
        youtubeLink: "https://youtu.be/osHX1QhHAD8?si=jjiHasd5DUgHfg5A",
        verses: [
            [
                { chord: "C", text: "(C) Je sais c'était le sang, Je sais c'était le sang ;" },
                { chord: "C", text: "(C) Je sais c'était le sang pour (G) moi;" },
                { chord: "F", text: "(F) Lorsque j’étais (C) perdu, (F) à la croix il (C) mourut," },
                { chord: "F", text: "(F) je sais c'était le (G) sang pour (C) moi." }
            ],
            [
                { chord: "C", text: "(C) Et son Sang est la vie, Et son Sang est la vie ;" },
                { chord: "C", text: "(C) Et son Sang est la vie pour (G) moi;" },
                { chord: "F", text: "(F) Tous mes péchés (C) lavés (F) Le salut est (C) acquis," },
                { chord: "F", text: "(F) Et son sang est la (G) vie pour (C) moi." }
            ],
            [
                { chord: "C", text: "(C) Si Christ n’était pas mort, Si Christ n’était pas mort ;" },
                { chord: "C", text: "(C) Si Christ n’était pas mort pour (G) moi ;" },
                { chord: "F", text: "(F) Je serais toujours (C) errant (F) Et n’ayant pas (C) la vie" },
                { chord: "F", text: "(F) Si Christ n’était pas (G) mort pour (C) moi." }
            ],
            [
                { chord: "C", text: "(C) L’amour de Dieu pour moi, L’amour de Dieu pour moi ;" },
                { chord: "C", text: "(C) L’amour de Dieu pour moi est si (G) grand ;" },
                { chord: "F", text: "(F) Depuis l’éternité (C) l’Agneau (F) fut (C) immolé," },
                { chord: "F", text: "(F) L’amour de Dieu est si (G) grand pour (C) moi." }
            ],
            [
                { chord: "C", text: "(C) Je suis heureux pour Christ, Je suis heureux pour Christ ;" },
                { chord: "C", text: "(C) Je suis heureux pour Christ, (G) Sauveur ;" },
                { chord: "F", text: "(F) De ce qu’il m’a (C) aimé et (F) m’a donné (C) la vie" },
                { chord: "F", text: "(F) je suis heureux pour (G) Christ, (C) Sauveur" }
            ],
            [
                { chord: "C", text: "(C) Je chante pour Jésus, Je chante pour Jésus ;" },
                { chord: "C", text: "(C) Je chante pour Jésus mon (G) Roi ;" },
                { chord: "F", text: "(F) Tous les jours (C) de ma vie (F) Je chante (C) alléluia" },
                { chord: "F", text: "(F) Je chante pour Jésus (G) mon (C) Roi" }
            ]
        ]
    },
    {
        ...
        verses: [
            [
                { chord: "C", text: " I believe the spoken word I believe !" },
                { chord: "C", text: " I believe the spoken word I believe !" },
                { chord: "F", text: " I believe the spoken word I believe !" },
                { chord: "F", text: " That’s why I’m happy and praising the Lord" }
            ]
        ]
    },
    {
    ...
    },
    {
        ...
        title: "REDEEMED",
        keySignature: "C",
        youtubeLink: "https://youtu.be/r_73lCWRuoQ?si=nQHm_Rt1IDizYAMt",
        verses: [
            [
                { chord: "C", text: "(C) Redeemed, how I love to proclaim it!" },
                { chord: "G", text: "(G) Redeemed by the blood of the (C) Lamb;" },
                { chord: "C", text: "(C) Redeemed through His infinite mercy," },
                { chord: "G", text: "(G) His child, and forever, I (C) am." }
            ],
            [
                { chord: "", text: "CHORUS:" },
                { chord: "F", text: "(F) Redeemed, (C) redeemed," },
                { chord: "G", text: "(G) Redeemed by the blood of the Lamb;" },
                { chord: "F", text: "(F) Redeemed, (C) redeemed," },
                { chord: "G", text: "(G) His child, and forever, I (C) am." }
            ],
            [
                { chord: "C", text: "(C) Redeemed and so happy in Jesus," },
                { chord: "G", text: "(G) No language my rapture can (C) tell;" },
                { chord: "C", text: "(C) I know that the light of His presence" },
                { chord: "G", text: "(G) With me doth continually (C) dwell." }
            ],
            [
                { chord: "C", text: "(C) I think of my Blessed Redeemer," },
                { chord: "G", text: "(G) I think of Him all the day (C) long;" },
                { chord: "C", text: "(C) I sing for I cannot be silent" },
                { chord: "G", text: "(G) His love is the theme of my (C) song." }
            ],
            [
                { chord: "C", text: "(C) I know I shall see in His beauty," },
                { chord: "G", text: "(G) The King in whose law I (C) delight;" },
                { chord: "C", text: "(C) Who lovingly guardeth My footsteps," },
                { chord: "G", text: "(G) And giveth me Songs in the (C) night." }
            ],
        ]
    },
    // Fin Cantiques Dimanche 22 Septembre 2024

// ------------------------------------------------------------------------------------ //
    
    // Debut Cantiques Dimanche 15 Septembre 2024
    {
        key: "dim-15-09-2024",
        title: "HE WAS NAILED TO THE CROSS",
        keySignature: "C",
    ...
    },
    {
        ...
        keySignature: "C",
        youtubeLink: "https://youtu.be/ucTT3YVPHSk?si=n1bcCTCfHv7ZcvCZ",
        verses: [
            [
                { chord: "C", text: "(C) Sweep over my soul, sweep (F) over my soul" },
                { chord: "F", text: "(F) Sweet (C) Spirit, sweep (D) over my (G) soul" },
                { chord: "C", text: "(C) My rest is complete while I (F) sit at your feet." },
                { chord: "F", text: "(F) Sweet (C) Spirit, sweep (G) over my (C) soul." }
            ]
        ]
    },
    {
    ...
    // Fin Cantiques Dimanche 15 Septembre 2024
...
// ------------------------------------------------------------------------------------ //
    ...
    // Fin Cantiques Dimanche 08 Septembre 2024
];
